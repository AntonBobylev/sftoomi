...
@Injectable()
class TuiDateToNativeDirective extends TuiValueTransformer<From, To>
{
    ...
    providers: [
        {
            ...
            useClass: TuiDateToNativeDirective,
        },
    ],
})
export default class TuiDateToNativeTransformerDirective
{
}
